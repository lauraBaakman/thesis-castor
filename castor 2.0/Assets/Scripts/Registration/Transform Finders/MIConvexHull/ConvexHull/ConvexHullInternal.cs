...
namespace MIConvexHull
{
    ...
    internal class ConvexHullInternal
    {
        ...
        /// <returns></returns>
        private IEnumerable<TVertex> GetConvexHullInternal<TVertex>(bool onlyCompute = false) where TVertex : IVertexPosition
        {
        ...
        internal static List<ConvexFaceInternal> GetConvexFacesInternal<TVertex, TFace>(IEnumerable<TVertex> data)
            ...
            where TVertex : IVertexPosition
        {
            ConvexHullInternal ch = new ConvexHullInternal(data.Cast<IVertexPosition>());
