  ...
  //};
    ...
    public class MathUtils
    {
                                                           ...
                                                           double[,] VT)
        {
            ...
            //float[,] Bf = OpenTKLib.MatrixUtilsNumerics.ToFloat(B);
            //float[,] Uf = OpenTKLib.MatrixUtilsNumerics.ToFloat(U);
        ...
        public static List<Vertex> TransformPoints(List<Vertex> a, Matrix4d matrix)//, bool matInverse)
        {

            List<Vertex> b = new List<Vertex>();

            double[,] matrixDouble = TransformPointsUtils.GetTransformMatrixAsDoubleArray(matrix);
            ...
            for (int i = 0; i < a.Count; i++)
            {
                ...
                pointTransformed = MathUtils.TransformPointDouble(pointSource, matrixDouble);
                //if(matInverse)
        ...
        public static List<Vector3d> TransformPoints(List<Vector3d> a, Matrix4d matrix)
        {
            ...
            for (int i = 0; i < a.Count; i++)
            {
                ...
                double[] pointReturn = MathUtils.TransformPointDouble(pointFloat, matrixDouble);
