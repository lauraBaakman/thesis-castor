    ...
    public class IGDTransformFinderTests
    {
        ...
        private static object[] FindTransformCases =
        {
            ...
            new object[] {
                ...
                new Matrix4x4D(
                    1.00000000000000e+000, 0.00000000000000e+000, 0.00000000000000e+000, 0.00000000000000e+000,
                    ...
                    0.00000000000000e+000, 0.00000000000000e+000, 0.00000000000000e+000, 1.00000000000000e+000
                ).ToUnityMatrix4x4()
            },
            ...
            new object[] {
                ...
                new Matrix4x4D(
                    +999.999815484386e-003, -370.655256081534e-006, +481.296036558626e-006, +16.6265046195479e-003,
                    +369.930439839439e-006, +999.998798785045e-003, +1.50518435302250e-003, +22.1409173161353e-003,
                    -481.853362910449e-006, -1.50500602923799e-003, +999.998751386315e-003, +38.8354427880211e-003,
                    +0.00000000000000e+000, +0.00000000000000e+000, +0.00000000000000e+000, +1.00000000000000e+000
                ).ToUnityMatrix4x4()
            },
            ...
            new object[] {
                ...
                new Matrix4x4D(
                    +999.999462263617e-003, +1.03458980407743e-003, +71.3891739114944e-006, -9.76981518931215e-003,
                    -1.03462391401174e-003, +999.999349849185e-003, +479.431500835381e-006, -269.613025185103e-006,
                    -70.8931125552470e-006, -479.505103974150e-006, +999.999882524504e-003, +5.89291830637307e-003,
                    +0.00000000000000e+000, +0.00000000000000e+000, +0.00000000000000e+000, +1.00000000000000e+000
                ).ToUnityMatrix4x4()
            },
            ...
            new object[] {
                ...
                new Matrix4x4D(
                    +999.999624988402e-003, +665.356379273881e-006, +554.368057477860e-006, +6.85734710804553e-003,
                    -666.455410843483e-006, +999.997808450991e-003, +1.98467387751939e-003, +21.8713420663516e-003,
                    -553.046327127907e-006, -1.98504259483517e-003, +999.997876870574e-003, +44.7270919891988e-003,
                    +0.00000000000000e+000, +0.00000000000000e+000, +0.00000000000000e+000, +1.00000000000000e+000
                ).ToUnityMatrix4x4()
            }
        };
