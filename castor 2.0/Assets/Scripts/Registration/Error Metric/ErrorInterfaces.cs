...
namespace Registration.Error
{
	...
	{
		double ComputeError(List<Vector4> XCs, List<Vector4> Ps, Vector4 translation, object sharedParameters);
		...
		Quaternion RotationalGradient(List<Vector4> XCs, List<Vector4> Ps, Vector4 translation, object sharedParameters);
		...
		/// <param name="Ps">The static points in the same order as the model points.</param>
		/// <param name="translation">The translation vector</param>///
		Vector4 TranslationalGradient(List<Vector4> XCs, List<Vector4> Ps, Vector4 translation, object sharedParameters);
		...
		object ComputeSharedParameters(List<Vector4> rotatedModelPoints, List<Vector4> staticPoints, Vector4 translation);
	}
