...
namespace Tests.DoubleConnectedEdgeList
{
    ...
    public class HalfEdgeTest
    {
        ...
        {
            HalfEdge thisHalfEdge = new HalfEdge(new Vertex(new Vector3(0, 1, 2), 0));
            HalfEdge otherHalfEdge = new HalfEdge(new Vertex(new Vector3(3, 4, 5), 0));
        ...
        {
            HalfEdge thisHalfEdge = new HalfEdge(new Vertex(new Vector3(3, 4, 5), 0));
            HalfEdge otherHalfEdge = new HalfEdge(new Vertex(new Vector3(0, 1, 2), 0));
        ...
        public void TestCompareTo_ObjEqualInPositionSmallerInTwin()
        {
            ...
            thisEdge.Twin = new HalfEdge(new Vertex(new Vector3(0, 1, 2), 0));
            otherEdge.Twin = new HalfEdge(new Vertex(new Vector3(3, 4, 5), 0));
        ...
        public void TestCompareTo_ObjEqualInPositionLargerInTwin()
        {
            ...
            thisEdge.Twin = new HalfEdge(new Vertex(new Vector3(3, 4, 5), 0));
            otherEdge.Twin = new HalfEdge(new Vertex(new Vector3(0, 1, 2), 0));
        ...
        public void TestCompareTo_ObjEqualInPositionSmallerInNext()
        {
            ...
            thisEdge.Next = new HalfEdge(new Vertex(new Vector3(0, 1, 2), 0));
            otherEdge.Next = new HalfEdge(new Vertex(new Vector3(3, 4, 5), 0));
        ...
        public void TestCompareTo_ObjEqualInPositionLargerInNext()
        {
            ...
            thisEdge.Next = new HalfEdge(new Vertex(new Vector3(3, 4, 5), 0));
            otherEdge.Next = new HalfEdge(new Vertex(new Vector3(0, 1, 2), 0));
        ...
        public void TestCompareTo_ObjEqualInPositionSmallerInPrevious()
        {
            ...
            thisEdge.Previous = new HalfEdge(new Vertex(new Vector3(0, 1, 2), 0));
            otherEdge.Previous = new HalfEdge(new Vertex(new Vector3(3, 4, 5), 0));
        ...
        public void TestCompareTo_ObjEqualInPositionLargerInPrevious()
        {
            ...
            thisEdge.Previous = new HalfEdge(new Vertex(new Vector3(3, 4, 5), 0));
            otherEdge.Previous = new HalfEdge(new Vertex(new Vector3(0, 1, 2), 0));
        ...
        {
            HalfEdge edge = new HalfEdge(new Vertex(new Vector3(5, 0, 0), 0));
            edge.Twin = new HalfEdge(new Vertex(new Vector3(2, 0, 0), 0));
        ...
        {
            HalfEdge edge = new HalfEdge(new Vertex(new Vector3(5, 3, -1), 0));
            edge.Twin = new HalfEdge(new Vertex(new Vector3(2, -4, 7), 0));
